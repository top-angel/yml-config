...
import { useInterval } from "../../context/chat/utils/useInterval";
import { throttle } from "../../context/chat/utils/throttle";
import Time from "../../context/chat/utils/Time";
import DecryptedMessage from "./DecryptedMessage";
import Postbox from "./Postbox";
import styles from "./Conversation.module.css";
import { IOrbisMessage } from "../../context/chat/DirectMessages/_types";
    ...
    <div className={styles.conversation}>
      {!hasLit ? (
        <div className={styles.connectLit}>
          ...
          <button disabled={false} onClick={() => connectLit()}>
            Generate private account
          </button>
        </div>
      ) : (
        <div className={styles.mainconverstaion}>
